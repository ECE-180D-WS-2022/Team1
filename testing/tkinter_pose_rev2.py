...
class App:
    def __init__(self, window, window_title, video_source = 0):
        ...
        self.pose = self.mp_pose.Pose(static_image_mode = True, min_detection_confidence=0.3, model_complexity=1)
        self.mp_drawing = mp.solutions.drawing_utils

        # open video source (by default this will try to open the computer webcam)
        self.vid = MyVideoCapture(self.mp_pose, self.pose, self.mp_drawing, self.video_source)
...
class MyVideoCapture:
    def __init__(self, mp_pose, pose, mp_drawing, video_source = 0):
